...
Identify the tech stack and key patterns from `package.json` and config files (project-specific conventions in the project's `CLAUDE.md` are auto-loaded — follow them).
...
2. **Determine tech stack FIRST** — from package.json/configs, follow the project's CLAUDE.md conventions
