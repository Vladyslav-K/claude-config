...
**Visual tasks:** Validator AGENT does the detailed comparison (Step 4 above). Orchestrator reviews the validator's report and decides on fixes. **If no validator agent was spawned, the task is NOT validated.**
