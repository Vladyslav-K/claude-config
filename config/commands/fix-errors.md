---
name: fix-errors
description: Run check-errors, lint, typecheck — find and fix all ERRORS across the project. Warnings are ignored.
---
...
If `check-errors` combines all three — run it once, then re-run individual scripts to isolate remaining errors.
