...
### Для браузерного тестування:
- акаунти, які використовує план, і яких бракує в `.project-meta/qa/accounts.md` — їх треба додати до `/run-tasks` (або їх створять самі тести)
```
